...
{
    cr_assert_str_eq(my_sub("5", "5"), "0");
}

Test(my_sub, five_minus_six)
{
    cr_assert_str_eq(my_sub("5", "6"), "-1");
}

Test(my_sub, six_minus_five)
{
    cr_assert_str_eq(my_sub("6", "5"), "1");
}

Test(my_sub, sub_high_numbered)
{
    cr_assert_str_eq(my_sub("45005", "5858"), "39147");
}

Test(my_sub, sub_high_numbered_neg)
{
    cr_assert_str_eq(my_sub("5858", "45005"), "-39147");
}
